...
export class ApproveServiceService {
    // Private
    private _item: BehaviorSubject<ApproveService | null> = new BehaviorSubject(null);
    private _items: BehaviorSubject<ApproveService[] | null> = new BehaviorSubject(null);
    private _itemsCate: BehaviorSubject<Category[] | null> = new BehaviorSubject(null);
    private _pagination: BehaviorSubject<ApproveServicePagination | null> = new BehaviorSubject(null);
    ...
    get pagination$(): Observable<ApproveServicePagination> {
        return this._pagination.asObservable();
    }

    get item$(): Observable<ApproveService> {
        return this._item.asObservable();
    }

    get items$(): Observable<ApproveService[]> {
     ...
     * Get product by id
     */
    getItem(id: string): Observable<ApproveService> {
    ...
    create(item: ApproveService): Observable<ApproveService> {
        return this.items$.pipe(
            take(1),
            switchMap(items => this._httpClient.post<ApproveService>(ENDPOINTS.combo, item).pipe(
                map((newItem) => {
